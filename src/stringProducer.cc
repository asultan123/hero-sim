...
StringProducer::StringProducer(sc_module_name moduleName) : sc_module(moduleName)
{
...
void StringProducer::sendString()
{
    ...
    trans.reset();
    trans.set_write();
    trans.set_data_ptr(reinterpret_cast<unsigned char *>(const_cast<char *>(testData.c_str())));
