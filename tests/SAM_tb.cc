...
template <typename DataType> struct SAM_TB : public sc_module
{
    ...
    bool validate_write_to_sam_1D()
    {
        ...
        Descriptor_2D generate_1D_descriptor_1(1, 10, DescriptorState::GENERATE, 9, 1, 0, 0);
    ...
    bool validate_read_from_sam_1D()
    {
        ...
        Descriptor_2D generate_1D_descriptor_1(1, 10, DescriptorState::GENERATE, 10, 1, 0, 0);
    ...
    bool validate_wait_with_data_write()
    {
        ...
        Descriptor_2D wait_descriptor(1, 10, DescriptorState::WAIT, 10, 1, 0, 0);
    ...
    bool validate_write_then_read_after_wait_1D()
    {
        ...
        Descriptor_2D generator_0_write_1D_descriptor(1, 10, DescriptorState::GENERATE, 9, 1, 0, 0);

        Descriptor_2D generator_0_write_suspend_descriptor(1, 0, DescriptorState::SUSPENDED, 0, 0, 0, 0);
        ...
        Descriptor_2D generator_1_wait_descriptor(1, 10, DescriptorState::WAIT, 2, 5, 0, 0);

        Descriptor_2D generator_1_read_1D_descriptor(2, 10, DescriptorState::GENERATE, 9, 1, 0, 0);

        Descriptor_2D generator_1_read_suspend_descriptor(2, 0, DescriptorState::SUSPENDED, 0, 0, 0, 0);
        ...
        for (unsigned int i = 1; i <= 15; i++)
        {
            if (i <= 10)
            {
                ...
                else if (i > 5)
                {
                    ...
                    {
                        cout << "@" << sc_time_stamp() << " external_channel_1_read_bus != " << expected_value
                             << " FAILED!" << endl;
    ...
    bool validate_concurrent_read_write_1D()
    {
        ...
        Descriptor_2D generator_0_write_1D_descriptor_1(1, 10, DescriptorState::GENERATE, 9, 1, 0, 0);
        ...
        Descriptor_2D generator_1_wait_descriptor(1, 20, DescriptorState::WAIT, 0, 0, 0, 0);

        Descriptor_2D generator_1_read_1D_descriptor_1(2, 10, DescriptorState::GENERATE, 9, 1, 0, 0);
        ...
        for (unsigned int i = 1; i <= 12; i++)
        {
            ...
            // at cycle 3 (i == 2) read channel has just been enabled, read values will only appear on bus @ cycle 4 (i
            // == 3)
            else if (i >= 3)
            {
